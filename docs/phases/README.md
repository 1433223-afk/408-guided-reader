...
| First Chapter Knowledge Map | [`FIRST_CHAPTER_KNOWLEDGE_MAP.md`](./FIRST_CHAPTER_KNOWLEDGE_MAP.md) | `CLOSED / COMPLETE` — machine acceptance PASS; agent real-use PASS; user acceptance PASS; narrow independent review PASS (P0=0 / P1=0 / P2=0; closure recommendation CLOSE) |
